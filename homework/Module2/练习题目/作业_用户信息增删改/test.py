...
def verify(staff_temp,condition):    #员工信息验证函数，传入一个员工对象和条件字符串
 ...
 for i in condition_list:
  if i in logic_str:
   if(len(logic_exp)!=0):
    print(str(logic_cal(staff_temp,logic_exp)),'___logic_cal')
